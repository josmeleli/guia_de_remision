                            ...
                            <div class="card-body collapse" id="conductor-form">
                                ...
                                <form action="/transportista" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            <input type="text" class="form-control mt-2" id="rucDos" name="RUC" placeholder=" " data-token="{{ env('RUC_API_TOKEN') }}" maxlength="11" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            <input type="text" class="form-control mt-2" id="nombres" name="nombre" placeholder=" " maxlength="50" required>
                        ...
                        <div class="card-body collapse conductor-form" id="conductor-form">
                            <form action="{{ route('conductor.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control mt-2" id="dni" name="dni" placeholder=" " minlength="8" maxlength="8" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control mt-2" id="telefono" name="telefono" placeholder=" " minlength="9" maxlength="9" required>
                                    <label for="telefono" class="form-control-label">Teléfono:</label>
                                </div>

                                <div class="form-group">
                                    <select class="form-control mt-2" id="id_vehiculo" name="id_vehiculo" required>
                                        <option value="" selected disabled hidden>ID Vehiculo</option>
                                    ...
                                    <label for="id_vehiculo" class="form-control-label">Vehiculo:</label>
                                </div>
                    ...
                    <div class="card card-info flex-fill" style="box-shadow: 1px 3px 20px 0px rgb(9, 3, 44)">
                        ...
                        <div class="card-body collapse" id="carga-form">
                            <form action="{{ route('carga.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col">
                                        <select class="form-control mt-2" id="id_conductor" name="id_conductor" required>
                    ...
                    <div class="card card-info flex-fill" style="box-shadow: 1px 3px 20px 0px rgb(9, 3, 44)">
                        ...
                        <div class="card-body collapse" id="agricultor-form">
                            <form action="{{ route('agricultor.store') }}" method="POST" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control mt-2" id="ruc" name="ruc" placeholder=" " maxlength="11" required>
                                    <label for="ruc" class="form-control-label">RUC:</label>
                                </div>
                                <div class="form-group">
